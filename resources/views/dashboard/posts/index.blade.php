...
<div class="row">
  <div class="table-responsive ms-auto col-md-9">
        ...
        <tr>
          ...
          <td>
            ...
            <form action="/dashboard/posts/{{$post->slug}}" method="post" class="d-inline">
              @method("delete")
              @csrf
              <button class="badge bg-danger border-0" onclick="return confirm('Are you sure about that ? ');"> <span data-feather="x-circle" class=" align-text-bottom"></span></button>
            </form>
